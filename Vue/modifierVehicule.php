            ...
            <div class="container-fluid">
                <div class="col-lg-12">
                    <div class="d-flex align-items-center">
                        <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">Liste des véhicules</a>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Modifier véhicule</h4>
                        </div>

                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" action="<?= URL ?>vehicule/updated" method="post">

                                    <input type="hidden" class="form-control" name="idVehicule" value="<?= $idVehicule ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="numeroImmatriculation" value="<?= $vehicule['numeroImmatriculation']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="mdate" name="anneeCirculation" value="<?= $vehicule['anneeCirculation']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="marque" value="<?= $vehicule['marque']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="type" value="<?= $vehicule['type']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-digits" name="puissance" value="<?= $vehicule['puissance']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="serie" value="<?= $vehicule['serie']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="etat" value="<?= $vehicule['etat']; ?>">
                                            </div>
                                        </div>
                                    </div>
