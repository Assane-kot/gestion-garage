...
$userData = new InterventionController();
?>
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block">
                        <div class="mr-auto mb-sm-0 mb-3">
                            <h4 class="card-title mb-2">Liste Interventions</h4>
                        </div>
                        <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1">Ajouter intervention</a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display">
                                ...
                                <tbody>
                                    <?php $InterventionController = new InterventionController(); ?>
                                    <?php if ($InterventionController->getIntervention()) : ?>
                                        <?php foreach ($InterventionController->getIntervention() as $intervention) : ?>
                                            <tr>
                                                <th><?= $intervention['typeIntervention'] ?></th>
                                                <th><?= $intervention['dateDebut'] ?></th>
                                                <th><?= $intervention['dateFin'] ?></th>
                                                <th><?= $intervention['numeroimmatriculation'] ?></th>
                                                <th><?= $intervention['prenomDemandeur'] . ' ' . $intervention['nomDemandeur'] ?></th>
                                                <td style="max-width: 20px;">
                                                    <div class="d-flex action-button">
                                                        <a href="<?= URL ?>intervention/modifierIntervention/<?= $intervention['idIntervention'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                        <a href="<?= URL ?>intervention/detail/<?= $intervention['idIntervention'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-eye"></i></a>
                                                        <a class="delete-link"><button class="btn btn-danger shadow btn-xs sharp mr-1" data-toggle="modal" data-target="#deleteModal" data-id="<?= $intervention['idIntervention'] ?>"><i class="fa fa-trash"></i></button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
