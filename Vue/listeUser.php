                                            ...
                                            <tr>
                                                ...
                                                <td style="max-width: 20px;">
                                                    <div class="d-flex action-button">
                                                        <a href="<?= URL ?>user/modifierUser/<?= $user['idUser'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                        <a class="delete-link"><button class="btn btn-danger shadow btn-xs sharp mr-1" data-toggle="modal" data-target="#deleteModal" data-id="<?= $user['idUser'] ?>"><i class="fa fa-trash"></i></button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
            ...
            $(document).ready(function() {
                $('#deleteModal').on('show.bs.modal', function(e) {
                    ...
                    $('#delete-btn').click(function() {
                        window.location.href = appConfig.baseUrl + 'user/deleted/' + id;
                    });
                });
            });
        </script>
