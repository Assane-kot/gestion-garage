...
$i = $Intervention->findByIdFull($idIntervention);

$PieceController = new PieceController();
$pieces = $PieceController->getPiece();
?>
<!DOCTYPE html>
<html lang="fr">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" action="<?= URL ?>intervention/updated" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" id="date-format" class="form-control" name="dateDebut" value="<?= $dateDebut ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="date" id="date-format" class="form-control" name="dateFin" value="<?= $dateFin ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control" id="val-skill" name="type" value="<?= $type ?>">
                                            ...
                                            <table id="example" class="display">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" id="val-digits" name="quantite">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
