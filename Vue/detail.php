                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Pièces utilisées</h4>
                            </div>
                            <div class="card-body">
                                <div>
                                    <table class="table verticle-middle table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <?php if ($interventionController->getPieceUtilisees($idIntervention)) : ?>
                                                <?php foreach ($interventionController->getPieceUtilisees($idIntervention) as $pieceUtilisees) : ?>
                                                    <tr>
                                                        <th><?= $pieceUtilisees['nomPiece'] ?></th>
                                                        <th><?= $pieceUtilisees['qpu'] ?></th>
