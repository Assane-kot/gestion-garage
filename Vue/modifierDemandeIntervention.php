...
@session_start();
$DemandeIntervention = new DemandeInterventionController();
$idDemandeIntervention = $url[2];
$di = $DemandeIntervention->findByIdFull($idDemandeIntervention);

$VehiculeController = new VehiculeController();
$vehicules = $VehiculeController->getVehicule();
?>
        ...
        <div class="container-fluid">
            <div class="col-lg-12">
                <div class="d-flex align-items-center">
                    <a href="../javascript:void(0);" class="btn btn-xs btn-primary light mr-1">Liste des demandes d'interventions</a>
                </div>
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Modifier demande intervention</h4>
                    </div>

                    <div class="card-body">
                        <div class="form-validation">
                            <form class="form-valide" action="<?= URL ?>demandeIntervention/updated" method="post">
                                <input type="hidden" class="form-control" name="idDemandeIntervention" value="<?= $idDemandeIntervention ?>">
                                ...
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="date-time" class="form-control" id="mdate" name="date" value="<?= $di['dateIntervention']; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-digits" name="kilometrage" value="<?= $di['kilometrage']; ?>">
                                            <input type="hidden" class="form-control" id="val-digits" name="demandeur" value="<?= $di['demandeur']; ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control" name="vehicule">
                                                <option value=" <?php echo $di['idVehiculeDi']; ?>"><?= $di['numeroimmatriculation'] . "  " . $di['marque'] ?></option>
                                ...
                                <div class="form-group">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control" rows="4" id="comment" name="commentaire"><?= htmlspecialchars($di['commentaire']); ?></textarea>
                                        </div>
                                    </div>
