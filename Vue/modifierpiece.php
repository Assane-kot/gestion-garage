                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-sm-flex d-block">
                            ...
                            <a href="listePiece.php" class="btn btn-xs btn-primary light mr-1">Liste pièces</a>
                        </div>
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" action="<?= URL ?>piece/updated" method="post">
                                    <input type="hidden" class="form-control" name="idPiece" value="<?= $idPiece ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="nomPiece" value="<?= $piece['nomPiece']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="reference" value="<?= $piece['reference']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-digits" name="quantite" value="<?= $piece['quantite']; ?>">
                                            </div>
                                        </div>
                                    </div>
