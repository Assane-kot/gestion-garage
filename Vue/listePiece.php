                ...
                <?php
                    ...
                    <div class="card-header d-sm-flex d-block">
                        <div class="mr-auto mb-sm-0 mb-3">
                            <h4 class="card-title mb-2">Liste pièces</h4>
                        </div>
                        <a href="addPiece.php" class="btn btn-xs btn-primary light mr-1">Ajouter pièce</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php if ($PieceController->getPiece()) : ?>
                                        <?php foreach ($PieceController->getPiece() as $piece) : ?>
                                            <tr>
                                                <th><?= $piece['nomPiece'] ?></th>
                                                <th><?= $piece['reference'] ?></th>
                                                <th><?= $piece['quantite'] ?></th>

                                                <td style="max-width: 20px;">
                                                    <div class="d-flex action-button">
                                                        <a href="<?= URL ?>piece/modifier/<?= $piece['idPiece'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                        <a class="delete-link"><button class="btn btn-danger shadow btn-xs sharp mr-1" data-toggle="modal" data-target="#deleteModal" data-id="<?= $piece['idPiece'] ?>"><i class="fa fa-trash"></i></button></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
    ...
    ***********************************-->
    ...
    $('#deleteModal').on('show.bs.modal', function(e) {
        ...
        $('#delete-btn').click(function() {
            window.location.href = appConfig.baseUrl + 'piece/deleted/' + id;
        });
    });
});
