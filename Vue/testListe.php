								...
								<table id="example3" class="display" style="min-width: 845px">
									...
									<tbody>
										...
										<?php if ($UserController->getUser()) : ?>
											<?php foreach ($UserController->getUser() as $user) : ?>
												<tr>
													<th><?= $user['prenom'] ?></th>
													<th><?= $user['nom'] ?></th>
													<th><?= $user['mail'] ?></th>
													...
													<td style="max-width: 20px;">
														<div class="d-flex action-button">
															<a href="modifierUtilisateur?idU=<?= $user['idUser'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
															<button type="button" class="btn btn-danger shadow btn-xs sharp" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-trash"></i></button>
														</div>
													</td>
												</tr>
											<?php endforeach; ?>
	...
	<tbody>
		...
		<?php if ($VehiculeController->getVehicule()) : ?>
			<?php foreach ($VehiculeController->getVehicule() as $vehicule) : ?>
				<tr>
					<th><?= $vehicule['numeroimmatriculation'] ?></th>
					<th><?= $vehicule['anneeCirculation'] ?></th>
					<th><?= $vehicule['marque'] ?></th>
					<th><?= $vehicule['type'] ?></th>
					<th><?= $vehicule['puissance'] ?></th>
					<th><?= $vehicule['serie'] ?></th>
					<th><?= $vehicule['etat'] ?></th>

					<td style="max-width: 20px;">
						<div class="d-flex action-button">
							<a href="modifierVehicule.php?idV=<?= $vehicule['idVehicule'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
							<a onclick="return confirm('Voulez vous confirmer votre supression')" href="../controller/vehiculeDelete.php?idVehicule=<?= $vehicule['idVehicule'] ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
						</div>
					</td>
				</tr>
			<?php endforeach; ?>
