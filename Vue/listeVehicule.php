            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <?php
                        ...
                        ?>
                        <h4 class="card-title">Liste véhicules</h4>
                    </div>
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td style="max-width: 20px;">
                                                    <div class="d-flex action-button">
                                                        <a href="<?= URL ?>vehicule/modifierVehicule/<?= $vehicule['idVehicule'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                        <a class="delete-link"><button class="btn btn-danger shadow btn-xs sharp mr-1" data-toggle="modal" data-target="#deleteModal" data-id="<?= $vehicule['idVehicule'] ?>"><i class="fa fa-trash"></i></button></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
        ...
        $(document).ready(function() {
            $('#deleteModal').on('show.bs.modal', function(e) {
                ...
                $('#delete-btn').click(function() {
                    window.location.href = appConfig.baseUrl + 'vehicule/deleted/' + id;
                });
            });
        });
    </script>
